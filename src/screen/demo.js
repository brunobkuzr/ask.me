...
const Demo = () => {
    ...
    const buscaDados = async (e) => {
        ...
        try {
            const {data} = await axios.get('https://hackathon.lince.com.br/api/exemplo');
    ...
    return (
        <>
            ...
            <section>
                ...
                <br/>
                <ul>
                    <li>Button é um componente, precisa ser importado: <b>import Button from '@mui/material/Button';</b>
                    </li>
                </ul>
